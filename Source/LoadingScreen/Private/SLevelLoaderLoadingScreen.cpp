...
#include "SLevelLoaderLoadingScreen.h"
...
#define LOCTEXT_NAMESPACE "SLevelLoader"
...
void SLevelLoaderLoadingScreen::Construct(const FArguments& InArgs, const FLoadingScreenDescription& InScreenDescription)
{
	const ULevelLoaderSettings* Settings = GetDefault<ULevelLoaderSettings>();
...
float SLevelLoaderLoadingScreen::GetDPIScale() const
{
