...
#include "LevelLoaderSettings.generated.h"

USTRUCT(BlueprintType)
struct LOADINGSCREEN_API FLevelLoaderDescription
{
	GENERATED_USTRUCT_BODY()

	FLevelLoaderDescription();
...
class LOADINGSCREEN_API ULevelLoaderSettings : public UDeveloperSettings
{
